  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-t from-[#ACBAFF] to-[#676F99] p-4">
      <ScrollRevealAvancado delay={300}>
        ...
        <div className="relative w-full max-w-[600px] h-[580px] pt-8 sm:p-4 rounded-3xl bg-gradient-to-b from-[#4741A6] to-[#ACBAFF] flex flex-col items-center z-10 shadow-2xl rounded-[20px]">
